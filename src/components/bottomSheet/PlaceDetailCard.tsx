      ...
      <div className="flex flex-col items-center px-2">
        ...
        <div className="p-2 w-full">
          ...
          <div className="flex justify-between pb-2 items-end border-b border-[var(--text-muted)]">
            <p className="text-sm text-black">{transformEngCategory(location.categories[0])}</p>
            <p className="text-xs text-black">{location.address}</p>
          </div>
          <div className="w-full flex flex-row justify-aroundtext-black items-center gap-2">
