...
export const CategoryPills = ({ categories, selected, onSelect }: CategoryPillsProps) => {
  ...
  return (
    <div className="flex gap-2.5 px-5 py-3.5 overflow-x-auto bg-[var(--bg-secondary)] scrollbar-hide">
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? 'bg-gradient-to-r from-accent-pink/30 to-accent-purple/30 border-accent-pink text-white shadow-[0_0_20px_var(--shadow-color)]'
